...
PAT_10K = re.compile(r'(?!.*?/A)\|10-?K(SB|SB40|405)?\|', re.IGNORECASE)
PAT_10KA = re.compile(r'(\|10-?K(SB|SB40|405)?(/A))\|', re.IGNORECASE)
PAT_10Q = re.compile(r'(?!.*?/A)\|10-?Q(SB|SB40|405)?\|', re.IGNORECASE)
PAT_10QA = re.compile(r'(\|10-?Q(SB|SB40|405)?(/A))\|', re.IGNORECASE) 
PAT_8K = re.compile(r'\|8.?K\|', re.IGNORECASE)
PAT_FNAME = re.compile(r'\|(edgar/data.*\/([\d-]+\.txt))', re.IGNORECASE)
